...
// Draw Detection
void draw_detections_cv_v3(mat_cv* show_img, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output, float fps);
...
void draw_detections_cv_v3_my(mat_cv* show_img, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output, float fps, std::vector<tracker> trackers, float averageSpeed);
